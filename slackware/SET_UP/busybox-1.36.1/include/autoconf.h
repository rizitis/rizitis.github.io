 ...
 */
#define AUTOCONF_TIMESTAMP "2024-05-27 23:52:39 EEST"
...
#define ENABLE_LOOP_CONFIGURE 1
#ifdef MAKE_SUID
# define IF_LOOP_CONFIGURE(...) __VA_ARGS__ "CONFIG_LOOP_CONFIGURE"
#else
# define IF_LOOP_CONFIGURE(...) __VA_ARGS__
#endif
#define IF_NOT_LOOP_CONFIGURE(...)
